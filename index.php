                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="taital_main">
                              <h4 class="banner_taital"><span class="font_size_90">50%</span> Off On First Order</h4>
                              <p class="banner_text">Khetias supermarket is a World of Choice best known for its affordable products </p>
                              <div class="book_bt"><a href="product_list.php">Shop Now</a></div>
                           </div>
                        </div>
                        <div class="col-md-6">
      ...
      <div class="container">
         <div class="row">
            <div class="col-lg-6 col-sm-12">
               <h4 class="information_text">About Khetias</h4>
               <p class="dummy_text">As a corporate, we strive for excellence to be the best in all areas of business by
                   putting our clients at the heart of everything we do to make a positive impact through leadership, 
                   innovation & passion, customer service and integrity in offering quality, service, price and choice leading to
                    improved standards of living to our customers at all level.
               </p>
            </div>
            <div class="col-lg-3 col-sm-6">
               <div class="information_main">
                  <h4 class="information_text">Useful Links</h4>
                  <p class="many_text">Home <br>About<br> Contact Us </p>
               </div>
            </div>
            <div class="col-lg-3 col-sm-6">
               <div class="information_main">
                  <h4 class="information_text">Contact Us</h4>
                  <p class="call_text"><a href="#">+254 740 411405</a></p>
                  <p class="call_text"><a href="#">+254 789 459728</a></p>
                  <p class="call_text"><a href="#">khetiasdrapers@gmail.com</a></p>
         ...
         <div class="copyright_section">
            <h1 class="copyright_text">
               Copyright 2023 All Right Reserved <a href="https://html.design"> Khetias Supermarket</a>
         </div>
      </div>
   </div>
   <!-- footer section end -->
